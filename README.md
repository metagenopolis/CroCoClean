...
An example abundance table is available [here](https://github.com/metagenopolis/CroCoDeEL/blob/main/crocodeel/test_data/mgs_profiles_test.tsv).
...
An example is available [here](https://github.com/metagenopolis/CroCoDeEL/blob/main/crocodeel/test_data/results/contamination_events.tsv).
